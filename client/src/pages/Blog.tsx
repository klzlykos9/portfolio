      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          {blogs.length > 0 && (
            ...
            >
              <div className="rounded-3xl overflow-hidden border border-white/8 bg-slate-900/60 backdrop-blur-sm group hover:border-cyan-500/25 transition-all duration-500">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-6 sm:p-10 flex flex-col justify-center">
                    <span className="inline-flex items-center gap-1.5 text-cyan-400 text-xs font-black uppercase tracking-widest mb-4">
                      <span className="w-1.5 h-1.5 bg-cyan-400 rounded-full animate-pulse" />
                      Featured Article
                    </span>
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-black text-white mb-4 leading-tight">{blogs[0].title}</h2>
                    <p className="text-slate-400 text-sm sm:text-base mb-6 line-clamp-3 leading-relaxed">{blogs[0].excerpt}</p>
                    <div className="flex items-center text-xs text-slate-500 mb-7 gap-3">
