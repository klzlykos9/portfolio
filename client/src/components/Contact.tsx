      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <a href="mailto:arpanpnayak@gmail.com" className="flex items-center space-x-4 group">
                <Mail className="text-pink-600 group-hover:scale-110 transition-transform" size={24} />
                <div>
