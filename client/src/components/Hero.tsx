      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 w-full relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-white via-cyan-300 to-blue-400 bg-clip-text text-transparent leading-tight mb-6"
          >
            Arpan P. Nayak
          </motion.h1>
          ...
          <motion.h2
            variants={itemVariants}
            className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent mb-6"
          >
